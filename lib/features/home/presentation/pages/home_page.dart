  ...
  Widget _buildMainContent(Authenticated state) {
    return PageView(
      ...
      children: [
        ...
        const Center(child: Text("Patients Ledger")),
        const Center(child: Text("Referral Hub")),
        const Center(child: Text("Facility Settings")),
      ],
    );
  }
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _navItem(Icons.settings_suggest_rounded, "Settings", 3),
        ],
      ),
    );
  }
...
class _DashboardTab extends StatelessWidget {
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(state.user.facilityName.toUpperCase(), style: const TextStyle(color: Colors.white70, fontSize: 10, fontWeight: FontWeight.w800, letterSpacing: 1)),
                const SizedBox(height: 8),
                Text('Dr. ${state.user.name}', style: const TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.w900)),
          ...
          // Action Grid
          _buildActionRow(context, Icons.person_add_rounded, "New Registration", "Capture NUPI Identification", () {
            Navigator.push(context, MaterialPageRoute(builder: (_) => const PatientRegistrationPage()));
          }),
          _buildActionRow(context, Icons.history_edu_rounded, "Visit Documentation", "Comprehensive Clinical Records", () {}),
          _buildActionRow(context, Icons.send_rounded, "Inter-facility Referral", "FHIR R4 Compliant Transfer", () {}),
          
          const SizedBox(height: 32),
          const Text("Disease Management", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900, color: Color(0xFF0F172A))),
          const SizedBox(height: 16),
  ...
  Widget _buildActionRow(BuildContext context, IconData icon, String title, String sub, VoidCallback onTap) {
    return Container(
