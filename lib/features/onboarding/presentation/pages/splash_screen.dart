...
//
// Animated Flutter splash — runs immediately after the native platform
// splash hands off to Flutter.  Plays the logo entrance + text animation,
// then calls [onComplete] so RootNavigator can decide what to show next.
//
...
class SplashScreen extends StatefulWidget {
  ...
  /// RootNavigator uses this to switch to AuthWrapper.
